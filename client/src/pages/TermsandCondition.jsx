...
const TermsAndConditions = () => {
  ...
  // Get formData and setAgreeToTerms from the navigation state
  const { formData, setAgreeToTerms } = location.state || {
    formData: {},
    setAgreeToTerms: () => {},
  };
  ...
  const handleCheckboxChange = () => {
    setIsChecked((prev) => {
      ...
      setAgreeToTerms(newChecked); // Update the state in Sign-Up component
      return newChecked;
    });
  };
  ...
  const handleBackToSignUp = () => {
    if (isChecked) {
      navigate("/signup", { state: { formData, agreeToTerms: isChecked } });
    }
  };
