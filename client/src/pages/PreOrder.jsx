                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex items-center justify-center space-x-4 mt-2">
                    ...
                    <button
                      onClick={() =>
                        setCurrentImageIndex((prev) =>
                          prev === furnitureData.images.length - 1
                            ? 0
                            : prev + 1
                        )
                      }
                    ...
                    <div className="mt-5 border border-teal-600 p-5">
                      ...
                      <div className="font-normal">
                        <div className="flex justify-between">
                          <span>
                            Furniture Price (<i>based on material</i>):
                          </span>
                      ...
                      <div>
                        ...
                        {paymentOption === "Partial Payment" && (
                          <div className="p-5 bg-slate-200 mb-5">
                            <strong>Partial Payment (3-Month Plan)</strong> Pay
                            in installments with 50% down payment and remaining
                            balance can be paid over a minimum of 3 months. 3%
                            Interest applies only if payments are not made on
                            time.
                          </div>
                        )}
                        ...
                        {paymentOption === "Full Payment" && (
                          <div className="p-5 bg-slate-200 mb-5">
                            <strong>Full Payment Pay</strong> the entire amount
                ...
                <div className="mt-5 border-t-2 border-gray-300 pt-5">
                  ...
                  {selectedDeliveryMode === "Pick Up" && (
                    <div className="mt-4 p-4 bg-slate-100 rounded-md">
                      ...
                      <p className="text-sm text-gray-500 mt-2">
                        Available pick up time: Monday-Saturday, 9:00 AM - 6:00
                        PM
                      </p>
                    </div>
                  )}
