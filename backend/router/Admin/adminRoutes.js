...
const {AdminSignup, AdminLogin, AllAdmins, verifyEmail, adminLogout, getAdminById, PendingAdminRequest, AcceptAdminRequest, ViewRequest, updateProfile, myProfile, unconfirmedAdmin, viewPendingOrder, AcceptOrder, getOrderId , cancelOrder, RejectAdminRequest, requestingForRepair, approvedRepairRequest, viewRepairRequest} = require('../../controllers/Admin/adminController');
...
router.get("/notifications/requesting-for-repair", checkAdminAuth, requestingForRepair);
router.get("/notifications/view-repair-request/:orderId", checkAdminAuth, viewRepairRequest)
router.post("/notifications/requesting-for-repair/approved/:orderId", checkAdminAuth, approvedRepairRequest);
