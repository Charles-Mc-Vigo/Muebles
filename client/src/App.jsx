...
import UserProfile from "./components/UserProfile";import InventoryPage from "./pages/InventoryPage";
	...
	return (
		<BrowserRouter>
			<Routes>
				...
				<Route
					path={`/furnitures/:id`}
					element={<ProtectedRoute element={ProductDetails} adminOnly={true} />}
				/>
				<Route
