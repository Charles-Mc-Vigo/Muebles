          ...
          <div className="bg-slate-100 p-6 rounded-lg flex flex-col h-full">
            <div className="flex-grow space-y-8">
              <div>
                ...
                <p className="mt-4 text-gray-600">{furnitureData.description}</p>
              </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border px-6 py-3 flex items-center space-x-2">
                      {furnitureData.colors && furnitureData.colors.length > 0 ? (
                        ...
                        <span className="text-gray-600">No colors available</span>
                      )}
                    </td>
                  </tr>
                  <tr>
            ...
            <div className="mt-8 flex justify-between space-x-6">
              <button className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-md transition-colors duration-300">
                Add to Cart
              </button>
              <Link
                to={`/furnitures/edit/${furnitureData._id}`}
                className="w-full text-center bg-green-600 hover:bg-green-700 text-white py-3 rounded-md transition-colors duration-300"
              >
                Edit
              </Link>
            </div>
