...
const ProductCard = ({
  ...
  return (
    <Link
      to={`/furnitures/${id}`}
      className="bg-white border-2 shadow-lg transition-transform transform hover:scale-105 p-6 flex flex-col justify-between w-auto"
    ...
    >
      ...
      <div className="flex-grow">
        <h3 className="text-xl font-bold text-gray-800"style={{ fontFamily: "Playfair Display, serif" }} >{name}</h3>
        <p className="mt-2 text-lg text-black"style={{ fontFamily: "Lato, sans-serif font-weight:400 font-style:normal" }}>₱ {price}</p>
        <p className="mt-2 text-gray-500"style={{ fontFamily: "Playfair Display, serif" }} > 
