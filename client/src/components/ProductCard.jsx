...
const ProductCard = ({
  ...
  return (
    <div className="bg-white  border rounded-md shadow-2xl border-teal-400 transition-transform transform hover:scale-105 p-3  flex flex-col justify-between w-auto">
