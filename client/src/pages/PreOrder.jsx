	...
	return (
		<>
			{loading ? (
				...
				<div className="mx-auto flex flex-col h-screen w-screen justify-center">
					<div className="mx-auto p-5 flex flex-col lg:flex-row">
						<div className="flex flex-col lg:w-[800px] p-5 bg-white rounded-xl shadow-xl shadow-gray-300 relative">
							<button
								onClick={() => navigate(-1)}
