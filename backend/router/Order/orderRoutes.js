...
router.get("/uploaded-images-orders/:orderId", checkUserAuth,orderController.ImageUploadedOrderById);
router.post("/uploaded-images-orders/continue/:orderId", checkUserAuth,upload.single("proofOfPayment"), orderController.ContinueImageOrder);
