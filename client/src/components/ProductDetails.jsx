...
function ProductDetails({ admin }) {
    ...
    useEffect(() => {
        ...
        const fetchFurnitureDetails = async () => {
            try {
                ...
                setPrice(data.price); // Set initial price from fetched data
            } catch (error) {
    ...
    const handleMaterialClick = (material) => {
        ...
        setPrice(material.price); // Update price based on selected material
			};
    ...
    const addToCart = async (e) => {
        ...
        const item = {
            ...
            size: selectedSize,
            price: price, // Include the updated price in the cart item
        };
        try {
