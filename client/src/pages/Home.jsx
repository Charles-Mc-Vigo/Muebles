...
const Home = () => { 
  ...
  const FilterSection = () => ( 
    <div className="flex flex-col w-full p-4 bg-gray-100 space-y-6 mt-5"> 
    ...
    <div className="bg-white text-gray-800 flex flex-col min-h-screen"> 
      ...
      <div className="flex flex-col md:flex-row flex-1 max-w-7xl mx-auto w-full px-4 py-6 gap-6"> 
        ...
        > 
          ...
          <div 
            className="md:hidden fixed inset-0 bg-black bg-opacity-50"onClick={toggleFilter}/> 
          {/* Filter Content */} 
          <div 
            className={` 
          ...
          `} 
          > 
            <h1 className="text-xl font-bold text-teal-600 mt-5 text-justify">JCKAME WoodWorks</h1> 
            {/* Close Button (Mobile) */} 
            <button 
              onClick={toggleFilter} 
