          ...
          <>
            ...
            <div className="border-t border-gray-300 pt-4 mt-5">
              ...
              <div className="flex gap-4">
                ...
                >
                  <img
                    src="/public/payment-icon/gcash.png"
                    alt="gcash"
                    className="w-16 h-16"
                  />
                </button>
                ...
                <button
                  ...
                  className={`px-8 py-4 rounded ${
                    selectedPaymentMethod === "Maya" ? "bg-black" : "bg-black"
                  } text-white`}
                >
                  <img
                    src="/public/payment-icon/maya.jpg"
                    alt="maya"
                    className="w-16 h-16"
                  />
                </button>
              ...
              <div>
                ...
                <div className="flex flex-col items-center">
                  <input
                    ...
                    className="mb-4 w-full max-w-md border border-gray-300 rounded-md px-3 py-2 text-gray-600 focus:border-green-500 focus:ring-green-500"
                  />
